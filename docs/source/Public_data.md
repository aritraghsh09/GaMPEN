...
There are many structural parameter catalogs that have been created using 
...
This is the flagship catalog that was made public along with the GaMPEN code-release in 2022/23. For more details about 
