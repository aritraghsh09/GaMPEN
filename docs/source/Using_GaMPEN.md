...
```{note}
The result aggregator module is mostly useful when you are predicting variables similar to the ones used in [Ghosh et. al. 2022](https://doi.org/10.3847/1538-4357/ac7f9e). For all other cases, you will need to modify this script according to the variables you are predicting or write your own script to aggregate the predictions. 
```
...
* **out_pdfs_path** (*str*; required variable) - Full path to the output directory that will contain the pdfs of the prediction distributions.
